classdef (StrictDefaults)AstrobeeSimulationRateControl < matlab.System
    %AstrobeeSimulationRateControl Regulates Simulink simulation update intervals according to wall-clock time
    %
